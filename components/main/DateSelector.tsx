      ...
      <div className={`flex items-center justify-between text-[#23222C]`}>
        <div
          className={`flex items-center hover:cursor-pointer p-2 mr-2 rounded-[8px] ${
            timeType === 'day' ? selectStyle : unSelectStyle
          }`}
          onClick={() => {
            setTimeType(`day`)
          }}
        ...
        <div
          className={`flex items-center hover:cursor-pointer p-2 mr-2 rounded-[8px] ${
            timeType === 'week' ? selectStyle : unSelectStyle
          }`}
          onClick={() => {
            setTimeType(`week`)
          }}
        ...
        <div
          className={`flex items-center hover:cursor-pointer p-2 mr-2 rounded-[8px] ${
            timeType === 'month' ? selectStyle : unSelectStyle
          }`}
          onClick={() => {
            setTimeType(`month`)
          }}
        ...
        <div
          className={`flex items-center hover:cursor-pointer p-2 mr-2 rounded-[8px] ${
            timeType === 'year' ? selectStyle : unSelectStyle
          }`}
          onClick={() => {
            setTimeType(`year`)
          }}
