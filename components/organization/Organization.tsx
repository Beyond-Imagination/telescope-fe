...
export default function Organization({ organizationName, summaryResponse, userScoreResponse, scoreListResponse, timeType, setTimeType }: any) {
    const colors: any = {
        createIssue: '#F2994A',
        resolveIssue: '#2F80ED',
    ...
    return (
        <div className={`py-[26px] px-[55px] flex flex-col`}>
            ...
            >
                ...
                <PieChart score={userScoreResponse?.score} title="User Score"></PieChart>
            </div>
